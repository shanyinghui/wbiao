...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                //配置放行地址
                .antMatchers(HttpMethod.GET,"/brand","/brand/all","/goods","/goods/enable","/goods/goodsDetails/*","/goods/sku/*","/spec/**").permitAll()
                .antMatchers("/category/**","/goods/insertCount").permitAll()
